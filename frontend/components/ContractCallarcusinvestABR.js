// TODO: invest in strats; ABR vault
...
const ArcusInvestABR = (props) => {
  ...
  function sendLoan() {
    ...
    let amount = window.prompt("Enter amount of $ABR you wanted to send.");
    ...
    doContractCall({
      ...
      functionName: "deposit-vault-abr",
  ...
  function takeLoan() {
    ...
    doContractCall({
      ...
      contractAddress: "ST39KDG85WZ340RAGGFY4FN3JMKYMEC1AEQHRM7TN",
      contractName: "arcus-vaults",
      functionName: "withdraw-vault-abr",
  ...
  return (
    <>
      <Stack direction="row" spacing={4} align="center">
        <Button variant="outline" onClick={() => withdrawVaultABR("ST39KDG85WZ340RAGGFY4FN3JMKYMEC1AEQHRM7TN", 1)}>
          Withdraw
        </Button>
        ...
        <Button
          variant="outline"
          onClick={() =>
            depositVaultABR("ST39KDG85WZ340RAGGFY4FN3JMKYMEC1AEQHRM7TN", 1)
          }
        >
          Deposit
        </Button>
